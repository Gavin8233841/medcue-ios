...
enum AppAccessibilityID {
    ...
    static let medicationPlanDoseValue = "plan.edit.doseValue"
    static let medicationPlanDoseUnit = "plan.edit.doseUnit"
    ...
    static let todayDoseConfirmTaken = "today.dose.confirmTaken"
