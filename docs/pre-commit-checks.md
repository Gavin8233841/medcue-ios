...
worktrees. Symbolic-link components in the configured hooks path are rejected
unless their physical target is a strict ancestor of the repository or common
