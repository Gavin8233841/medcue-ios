...
After the cleanup and budget fixes, four focused suites passed 40 tests with
...
readback races, accurate partial-failure text, and preservation of an open
task's displayed reminder.
